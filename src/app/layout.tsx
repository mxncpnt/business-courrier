...
export const metadata: Metadata = {
  ...
  description:
    "Résiliation, mise en demeure, réclamation, contestation… Remplis un formulaire, notre IA rédige un courrier professionnel adapté à ta situation. PDF prêt à envoyer dès 3,90 €, ou envoi postal inclus à partir de 5,90 €.",
