...
// Retourne { html, text } pour l'API Resend — aucune dépendance React Email requise.
...
<body style="margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  ...
  // Version texte brut (clients mail sans HTML, filtres anti-spam)
...
// Échappe les caractères HTML pour éviter les injections dans le template
